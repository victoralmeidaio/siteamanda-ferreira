...
const Links = () => {
    return (
        <div className="container-links" >
            ...
            <PopupComponent />
            <footer style={{
                height: '80px', width: '100%', backgroundColor: 'var(--cinza-claro)', justifyContent: 'center',
                alignItems: 'center', alignContent: 'center', display: 'flex', flexDirection: 'column',
            }}>

                <p style={{ textAlign: 'center', fontSize: '13px', fontWeight: '300', color: '#c2c2c2' }}>Studio Amanda Ferreira ® Todos os direitos reservados CNPJ 50.775.784/0001-06</p>
                <p style={{
                    textAlign: 'center', fontSize: '13px', fontWeight: '500',
                    color: '#c2c2c2', paddingTop: '4px',
                }}><a style={{ outline: 'none', textDecoration: 'none', color: '#c2c2c2' }} href="https://www.instagram.com/victorhhuggoo/">Desenvolvido por Victor Hugo🚀</a></p>
            </footer>
        </div>
    );
